window.translations = {
    en: {
        ...
        'books.book1.description': 'And the Angels Wept is a debut collection of short stories, originally written in Belarusian and Russian, and translated into English. The book carries the honest and painful voice of a people who have endured protests, repression, and hope. At the center are ordinary people facing moments of truth, fear, and faith — described with sincerity and humanity, without pathos but with a sense of respect.',
    ...
    by: {
        ...
        'books.book1.description': 'І плакалі анёлы — гэта дэбютны зборнік апавяданняў, напісаны на беларускай і рускай мовах. У кнізе гучыць шчыры і балючы голас народа, які перажыў пратэсты, рэпрэсіі і надзею. Аўтар паказвае людзей у іх самых праўдзівых і ўразлівых момантах — без прыкрас і штучнага героізму, але з глыбокай павагай да іх годнасці.',
