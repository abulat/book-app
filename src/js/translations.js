window.translations = {
    en: {
        ...
        'books.book1.description': 'And the Angels Wept is a debut collection of short stories, originally written in Belarusian and Russian, and translated into English. The book carries the honest and painful voice of a people who have endured protests, repression, and hope. Author portrays individuals in moments of truth, fear, and faith — as they are, without artificial heroism, but with human dignity.',
    ...
    by: {
        ...
        'books.book1.description': 'І плакалі анёлы — яго дэбютны зборнік апавяданняў, напісаны на беларускай і рускай мовах. У кнізе гучыць шчыры і балючы голас народа, які перажыў пратэсты, рэпрэсіі і надзею. Аўтар апісвае людзей у моманты праўды, страху і веры — такімі, якімі яны ёсць, без штучнага героізму, але з чалавечай годнасцю.',
